...
public partial class MainWindow : Window
{
    ...
    private void SetModuleButtons(bool enabled)
    {
        ...
        RpsButton.IsEnabled = enabled && _profile.AccessLevel == 4;
    }
    ...
    {
        await LaunchAppAsync("Dock Commander", "DockCommander", "DockCommander.Desktop", "DockCommander.exe");
    }

    private async void OpenBilling_Click(object sender, RoutedEventArgs e)
    {
        await LaunchAppAsync("Billing", "Billing", "PyleCentury.Billing.Desktop", "PyleCentury.Billing.exe");
    }

    private async void OpenRps_Click(object sender, RoutedEventArgs e)
    {
